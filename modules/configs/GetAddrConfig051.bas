...
Public Function GetAddrConfig051(xmlOrdb As Boolean) As Variant
    Dim conf0(33) As Variant
    Dim conf1(33) As Variant
    'XML теги                         'Поля в БД
    ...
    If xmlOrdb Then GetAddrConfig051 = conf0 Else GetAddrConfig051 = conf1
End Function
Public Function GetAddrTypes051() As Variant
    Dim conf(33) As Variant
    Dim i As Integer
    'Все строки
    For i = 0 To 33
        conf(i) = True
