...
Public Function GetConsConfig051 (xmlOrdb As Boolean) As String()
    Dim conf0 (25), conf1 (25) As String
    'XML теги                                         'Поля в БД
    ...
    If xmlOrdb GetConsConfig051 = conf0 Else GetConsConfig051 = conf1
End Function

Public Function GetConsTypes051 () As Boolean()
    Dim conf (25) As Boolean
    Dim i As Integer;
    'Все строки
    For i = 0 To 25
        conf (i) = true
