...
Public Function GetFlatConfig051 (xmlOrdb As Boolean) As String()
    Dim conf0 (23), conf1 (23) As String
    'XML теги                                         'Поля в БД
    ...
    If xmlOrdb GetFlatConfig051 = conf0 Else GetFlatConfig051 = conf1
End Function

Public Function GetFlatTypes051 () As Boolean()
    Dim conf (23) As Boolean
    Dim i As Integer;
    'Все строки
    For i = 0 To 23
        conf (i) = true
